...
#define SCREEN_TASK_SOFT_MASK_OFF 0U
#define SCREEN_TASK_SOFT_MASK_ON  1U
...
#ifndef APP_SCREEN_TASK_SOFT_MASK
#define APP_SCREEN_TASK_SOFT_MASK SCREEN_TASK_SOFT_MASK_OFF
#endif
...
#if ((APP_SCREEN_TASK_SOFT_MASK != SCREEN_TASK_SOFT_MASK_OFF) && \
     (APP_SCREEN_TASK_SOFT_MASK != SCREEN_TASK_SOFT_MASK_ON))
#error "APP_SCREEN_TASK_SOFT_MASK must be SCREEN_TASK_SOFT_MASK_OFF or SCREEN_TASK_SOFT_MASK_ON"
#endif
...
#define APP_SCREEN_TASK_SOFT_MASK_ENABLED \
  (APP_UART7_IS_SCREEN && (APP_SCREEN_TASK_SOFT_MASK == SCREEN_TASK_SOFT_MASK_ON))
